...
// ErrUnsupportedValue is returned when a parameter value cannot be coerced.
...
// BuildParamsFromOperation builds ImageOptions from a pipeline operation's params map.
