...
// parseOrigins replicates the parseOrigins logic from cmd/imaginary/main.go
// so that tests can construct []*url.URL values without depending on the main package.
